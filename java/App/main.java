...
public class main {
    ...
    private static void dangNhap()
    {
        ...
        while (dem>0)
        {
            System.out.print("Tài khoản đăng nhập:");
            String a=khoiTao.nextLine();
            System.out.print("Mật khẩu đăng nhập:");
    ...
    public  static void showAllDepartment()
    {
        for(int i=0;i<72;i++)
            System.out.print("_");
        System.out.println();
        System.out.printf("| %-20s %-30s %-15s", "ID Phòng Ban","Tên Phòng Ban", "Vị Trí");
        System.out.println();
    ...
    public static void themPB(Scanner in)
    {
        ...
        System.out.print("Nhập vị trị bộ phận:");
    ...
    public static void mainMenu()
    {
        ...
        System.out.println("| 8.Danh sách phòng ban.                                                     |");
    ...
    public static void tinhThueThuNhapCaNhan()
    {
        ...
        while(luachon!=0)
        {
            try
            {
                ...
                System.out.println("Thông tin lương của nhân viên "+e.getEmployees_name() +" là: " + luong+ " VND");
                luachon=0;
                ...
                {
                    System.out.println("Nhân viên "+e.getEmployees_name()+" phải nộp thuế :"+(luongTinhThue*0.05)+" VND ");
                    long l= (long) (luong-(luongTinhThue*0.05));
                    System.out.println("Số tiền thực nhận là:"+l + " VND");
                }
                else if(luongTinhThue>5000000 && luongTinhThue<=10000000)
                {
                    ...
                    System.out.println("Số tiền thực nhận là:"+l);
                }
